...
var DialogAggregator = /** @class */ (function () {
    function DialogAggregator(modules) {
        this.modules = modules;
    }
    DialogAggregator.prototype.getDialogsList = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        dialogs = _a.sent();
                        return [2 /*return*/, dialogs.flat()];
                }
            });
        });
    };
    return DialogAggregator;
}());
