...
var toLastMessageEntity = function (lastMessage) {
    ...
    var dialogId = (_b = lastMessage.chatId) === null || _b === void 0 ? void 0 : _b.toString();
    return {
...
var dialogPhotoPromise = function (client, entity) { return __awaiter(void 0, void 0, void 0, function () {
    var photoFile;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.downloadProfilePhoto(entity)];
            case 1:
                photoFile = _a.sent();
                if (typeof photoFile === 'string')
                    return [2 /*return*/, photoFile];
                return [2 /*return*/, photoFile === null || photoFile === void 0 ? void 0 : photoFile.toString('base64')];
        }
    });
}); };
var toDialogEntity = function (client, dialog) {
    var _a;
    var lastMessage = dialog.message;
    console.log('dialog', dialog);
    var chatPhoto = dialogPhotoPromise(client, dialog.entity);
